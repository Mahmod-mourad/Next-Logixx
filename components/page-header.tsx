...
export function PageHeader({ title, description, breadcrumbs }: PageHeaderProps) {
  return (
    <header className="bg-slate-50 dark:bg-slate-900 py-8 theme-transition">
      <div className="container">
        <nav className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 theme-transition">
