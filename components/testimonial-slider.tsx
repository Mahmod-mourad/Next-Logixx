...
const testimonials = [
  {
    ...
    content:
      "تعاملنا مع شركة Next Logix كان تجربة رائعة. قاموا بتطوير موقع إلكتروني احترافي لشركتنا وساعدونا في تحسين ظهورنا على الإنترنت. النتائج كانت مذهلة وزادت مبيعاتنا بشكل ملحوظ.",
  ...
  },
  {
    ...
    content:
      "فريق Next Logix من أفضل الفرق التي تعاملت معها. قاموا بتطوير تطبيق جوال لشركتنا بجودة عالية وفي وقت قياسي. التطبيق سهل الاستخدام وحاز على إعجاب عملائنا.",
  ...
  },
  {
    ...
    content:
      "ساعدتني شركة Next Logix في إنشاء متجر إلكتروني متكامل وتنفيذ حملات تسويقية ناجحة. الفريق محترف ومتعاون والنتائج تجاوزت توقعاتي. أنصح بشدة بالتعامل معهم.",
