  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-center">تحميل برنامج فوترة</DialogTitle>
          <DialogDescription className="text-center">
            يرجى ملء النموذج التالي للحصول على رابط تحميل النسخة التجريبية من برنامج فوترة
          </DialogDescription>
          <Button
            variant="ghost"
