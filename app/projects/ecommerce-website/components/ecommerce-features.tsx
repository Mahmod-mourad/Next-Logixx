...
const features = [
  {
    ...
    title: "تجربة تسوق متميزة",
    description: "واجهة مستخدم سهلة الاستخدام مع دعم كامل للغة العربية",
    color: "bg-blue-500",
  },
  {
    icon: <CreditCard className="w-6 h-6" />,
    title: "مدفوعات آمنة",
    description: "دعم لجميع وسائل الدفع مع حماية متقدمة للمعاملات",
    color: "bg-blue-600",
  },
  {
  ...
  },
  {
    ...
    title: "أداء عالي",
    description: "سرعة فائقة في معالجة الطلبات وتنفيذ العمليات",
    color: "bg-blue-800",
  },
  {
    icon: <Users className="w-6 h-6" />,
    title: "إدارة العملاء",
    description: "نظام متكامل لإدارة العملاء وتتبع الطلبات",
    color: "bg-blue-900",
  },
  {
    icon: <Settings className="w-6 h-6" />,
    title: "تخصيص كامل",
    description: "خيارات متقدمة لتخصيص المتجر والإعدادات",
    color: "bg-blue-950",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <Badge variant="outline" className="mb-4 bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
            ...
            <span className="text-blue-600 dark:text-blue-400">المميزات الرئيسية</span>
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">مميزات المتجر</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            نقدم مجموعة متكاملة من المميزات لضمان تجربة تسوق متميزة وآمنة
          </p>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 rounded-2xl p-8 text-white shadow-xl">
            <div className="grid md:grid-cols-4 gap-6 text-center">
              <div className="p-4 rounded-xl bg-white/10 backdrop-blur-sm">
                <ShoppingCart className="w-8 h-8 mx-auto mb-2 text-blue-200" />
                <div className="text-2xl font-bold">50K+</div>
                <div className="text-sm opacity-80">طلب شهري</div>
              </div>
              <div className="p-4 rounded-xl bg-white/10 backdrop-blur-sm">
