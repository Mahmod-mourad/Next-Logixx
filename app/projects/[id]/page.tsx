...
const projects = [
  ...
  },
  {
    ...
    description: "تطبيق سطح مكتب متكامل لإدارة الأعمال والمهام",
    fullDescription: "تطبيق سطح مكتب متكامل يتيح للمستخدمين إدارة أعمالهم ومهامهم بكفاءة عالية. يتضمن التطبيق واجهة مستخدم سهلة الاستخدام، وإدارة المهام، وتقارير الأداء، وتكامل مع الأنظمة الأخرى.",
    features: [
      "واجهة مستخدم سهلة الاستخدام",
    ...
    technologies: ["C#", ".NET Framework", "SQL Server", "Windows Forms", "DevExpress"],
    images: [
      "/placeholder.svg?height=600&width=800",
      "/placeholder.svg?height=600&width=800",
      "/placeholder.svg?height=600&width=800",
    ...
    relatedProjects: ["accounting-software", "inventory-system"],
    challenges: [
      "تطوير تطبيق سطح مكتب متكامل",
      "ضمان أداء عالي مع كميات كبيرة من البيانات",
      "تصميم واجهة مستخدم سهلة الاستخدام",
      "تكامل مع الأنظمة الأخرى",
    ],
    solutions: [
      "استخدام أحدث تقنيات تطوير تطبيقات سطح المكتب",
      "تصميم قاعدة بيانات مُحسنة",
      "تطوير واجهة مستخدم بسيطة وسهلة الاستخدام",
      "تنفيذ واجهات برمجة للتكامل",
    ],
    results: [
      "تحسين كفاءة العمل بنسبة 70%",
      "تقليل وقت إدارة المهام بنسبة 50%",
...
export function generateMetadata({ params }: { params: { id: string } }) {
  ...
  if (!project) return { title: "مشروع غير موجود | Next Logix" }
  return {
          ...
          <div className="container">
            <div className="grid gap-12 md:grid-cols-2 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-slate-700 dark:text-slate-300">{project.fullDescription}</p>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <Button className="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white" asChild>
            ...
            <div className="rounded-xl bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-700 dark:to-blue-900 p-8 md:p-12 theme-transition">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-4">
                  ...
                  <Button size="lg" className="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white" asChild>
                    <Link href="/quote">طلب عرض سعر</Link>
                  </Button>
                </div>
              </div>
