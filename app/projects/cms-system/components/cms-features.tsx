...
const features = [
  ...
  },
  {
    ...
    title: "إدارة المحتوى",
    description: "نظام متكامل لإدارة وتنظيم المحتوى بكفاءة عالية",
    color: "bg-blue-600",
  },
  {
          ...
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 rounded-2xl p-8 text-white shadow-xl">
            <div className="grid md:grid-cols-4 gap-6 text-center">
              <div className="p-4 rounded-xl bg-white/10 backdrop-blur-sm">
                <Layout className="w-8 h-8 mx-auto mb-2 text-blue-200" />
                <div className="text-2xl font-bold">200K+</div>
                <div className="text-sm opacity-80">صفحة</div>
              </div>
              <div className="p-4 rounded-xl bg-white/10 backdrop-blur-sm">
