...
export default function AccountingSoftwareClientPage() {
  ...
  const featureLists = [
    {
      id: "features-list-1",
      title: "مميزات الأصناف في برنامج محاسبة فوترة",
      items: [
    ...
    },
    {
      ...
      items: [
        "مع برنامج محاسبة فوترة يمكنك إدارة غاية في النظامية للمخازن، فتستطيع من خلاله إدارة الأصناف في نظام شجري متعدد التفريعات.",
    ...
    <div className="flex min-h-screen flex-col bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-50 theme-transition">
      ...
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { title: "فوترة", href: "/projects/accounting-software" },
        ]}
      />
          ...
          <section className="py-16">
            <div className="container">
              <div className="grid gap-12 md:grid-cols-2 md:items-center">
                <div>
                  <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white theme-transition">فوترة برنامج محاسبة يلبي كل احتياجاتك</h2>
                  <p className="mt-6 text-lg text-slate-700 dark:text-slate-300 theme-transition">
                    هل تبحث عن برنامج محاسبة يشمل كل الإمكانيات التي تجعلك قادراً على إدارة شركتك بكل سهولة؟ إليك فوترة فهو برنامج محاسبي سحابي "قلبه على مصلحتك" ينقل مستوى أعمالك إلى مستوى أعلى حيث يتم التسجيل الآلي
            ...
            <div className="container">
              <div className="mx-auto max-w-3xl text-center">
                <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white theme-transition">
                  مميزات المخازن والمستودعات في برنامج محاسبة فوترة
                </h2>
                <p className="mt-4 text-lg text-slate-700 dark:text-slate-300 theme-transition">
                  يتضمن برنامج محاسبة سحابي فوترة أدوات إدارة مختلف أنواع الحسابات في المحاسبة، مما يسهل تنفيذ الدورة
          ...
          <section className="py-16">
            <div className="container">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-slate-700 dark:text-slate-300 theme-transition">
                  أفضل برنامج محاسبي متكامل للشركات.. فوترة يشمل جميع ميزات الحسابات العامة
                </p>
              </div>
                ...
                <Tabs defaultValue="inventory" className="w-full">
                        ...
                        <ul className="mt-6 space-y-4">
                          <li key="inventory-feature-1" className="flex items-start gap-3">
                            ...
                            <p className="text-slate-700 dark:text-slate-300 theme-transition">
                              من خلال برنامج محاسبة فوترة، يمكن عمل جرد للمخازن بكل سهولة عن أي فترة سواء يومية أو شهرية
                          ...
                          <li key="inventory-feature-2" className="flex items-start gap-3">
                            <Check className="h-6 w-6 flex-shrink-0 text-blue-600 dark:text-blue-400" />
                            <p className="text-slate-700 dark:text-slate-300 theme-transition">
                              نظام محاسبة فوترة يوضح لك الطريقة التي تراها الأنسب لحساب تكلفة المخزون لديك سواء
                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white theme-transition">
                          برنامج محاسبة فوترة يوفر لك كل ما تحتاجه لإدارة منظومتك المالية
                        </h3>
                        <ul className="mt-6 space-y-4">
                          <li key="financial-feature-1" className="flex items-start gap-3">
                            ...
                            <p className="text-slate-700 dark:text-slate-300 theme-transition">
                              ...
                              فوترة في أفضل برنامج محاسبي فهو برنامج فوترة ومبيعات ومحاسبة يساعدك كدليل محاسبي شامل سهل
                  ...
                  <TabsContent value="hr">
                    <div className="grid gap-8 md:grid-cols-2">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white theme-transition">برنامج محاسبة فوترة لإدارة شؤون الموظفين</h3>
                        <ul className="mt-6 space-y-4">
                  ...
                  <TabsContent value="branches">
                    <div className="grid gap-8 md:grid-cols-2">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white theme-transition">برنامج محاسبة فوترة لإدارة الفروع</h3>
                        <ul className="mt-6 space-y-4">
