...
export const metadata = {
  title: "من نحن | Next Logix",
  description: "تعرف على شركة Next Logix وفريقنا وقيمنا ورؤيتنا",
}
...
export default function AboutPage() {
  ...
  const companyValues = [
    {
      ...
      title: "الرؤية",
      description:
        "نسعى لأن نكون الشريك الموثوق به في مجال التطوير البرمجي في المنطقة العربية، من خلال تقديم حلول مبتكرة ومستدامة.",
    },
    {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      image: "/assets/images/team/obada.jpg",
    },
    {
      name: "Mahmoud Mourad",
      ...
      image: "/assets/images/team/Mourad.jpg",
    },
  ]
    ...
    <div className="flex min-h-screen flex-col bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50 theme-transition">
      ...
      <PageTransition>
        <main className="flex-1">
              ...
              <div className="grid gap-8 md:grid-cols-2 md:items-center">
                <div>
                  ...
                  <div className="mt-4 space-y-3 text-slate-700 dark:text-slate-300 theme-transition">
                    <p className="text-lg">
                      تأسست شركة Next Logix في عام 2022 في مدينة 6 أكتوبر على يد مجموعة من المهندسين المحترفين
                      بهدف تقديم حلول برمجية متكاملة للشركات والمؤسسات في المنطقة العربية.
                    </p>
                    <p>
                      نحن نؤمن بأن التكنولوجيا يجب أن تكون أداة لتبسيط وتحسين العمليات التجارية، وليست
                      مصدرًا للتعقيد. لذلك، نركز على تطوير حلول سهلة الاستخدام وفعالة تلبي احتياجات عملائنا.
                    </p>
                    <p>
                      تتخصص الشركة في مجال البرمجة، حيث نقدم خدمات متكاملة تساعد عملائنا على النمو
                      والتوسع في السوق الرقمي بأحدث التقنيات.
                    </p>
                  </div>
            ...
            <div className="container">
              <div className="mx-auto max-w-2xl text-center mb-10">
                ...
                <p className="mt-2 text-slate-700 dark:text-slate-300 theme-transition">
                  يتكون فريقنا من مجموعة من المهندسين المتخصصين ذوي الخبرة في مختلف مجالات البرمجة
                </p>
              </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-700 dark:text-slate-300 theme-transition text-sm">
                          فريقنا يمتلك خبرة واسعة في مختلف مجالات البرمجة، مما يمكننا من تقديم حلول متكاملة وفعالة.
                        </p>
                      </div>
                    </div>
                  </CardContent>
          ...
          {/* Projects Section */}
          <section className="py-10 bg-slate-50 dark:bg-slate-900/50 theme-transition">
            <div className="container">
              <div className="mx-auto max-w-2xl text-center mb-10">
                <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white theme-transition">مشاريعنا</h2>
                <p className="mt-2 text-slate-700 dark:text-slate-300 theme-transition">
                  تعرف على المشاريع التي قامت بها شركة Next Logix
                </p>
              </div>
              <div className="grid gap-6 md:grid-cols-3">
                <Card className="bg-white dark:bg-slate-800 dark:border-slate-700 theme-transition hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6">
                    <div className="mb-4 h-14 w-14 rounded-lg bg-blue-100 p-3 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 theme-transition">
                      <Globe className="h-6 w-6" />
                    </div>
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white theme-transition mb-2">تطبيق سطح مكتب</h3>
                    <p className="text-slate-700 dark:text-slate-300 theme-transition text-sm">
                      تطوير تطبيقات سطح المكتب باستخدام أحدث التقنيات والأدوات لتحسين كفاءة الأعمال.
                    </p>
                  </CardContent>
                </Card>
                <Card className="bg-white dark:bg-slate-800 dark:border-slate-700 theme-transition hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white theme-transition mb-2">تطبيقات الويب</h3>
                    <p className="text-slate-700 dark:text-slate-300 theme-transition text-sm">
                      تصميم وتطوير تطبيقات ويب متكاملة باستخدام أحدث التقنيات والأطر البرمجية.
                    </p>
                  </CardContent>
                </Card>
                <Card className="bg-white dark:bg-slate-800 dark:border-slate-700 theme-transition hover:shadow-lg transition-all duration-300">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white theme-transition mb-2">تطبيقات الموبايل</h3>
                    <p className="text-slate-700 dark:text-slate-300 theme-transition text-sm">
                      تطوير تطبيقات موبايل متكاملة لنظامي Android و iOS باستخدام أحدث التقنيات.
                    </p>
                  </CardContent>
                </Card>
              </div>
      ...
      <Footer />
      <WhatsAppButton phoneNumber="+201020384694" />
    </div>
  )
}
